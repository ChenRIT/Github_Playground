               ...
               i+1 < len(sents):
                ...
                for token in next_sent:
                    ...
                    if token.pos == NUM and (tk_idx - begin_idx) < len(next_sent) - 1:
                        ...
                        if "kg" in next_token_text or \
                           "lbs" in next_token_text or \
                           "pounds" in next_token_text or \
                           "kilograms" in next_token_text or \
                           "ounces" in next_token_text or \
                           "gallons" in next_token_text:
                            is_valid = True
                            break
